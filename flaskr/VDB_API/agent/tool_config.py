...
TOOLS = [
    {
        ...
        "name_for_model": "NTTU_LLM",
        "description_for_model": "unless there is a specific request for an online search or for performing mathematical calculations, please always opt for this chain, which is activated to provide highly accurate responses, particularly for questions pertaining to National Taitung University(NTTU)(國立臺東大學)",
        "parameters": [
            {
                "name": "query",
                "type": "string",
    ...
    #     "name_for_model": "unstable Search",
    ...
    # 數學計算工具
    {
        ...
        "description_for_model": "Useful for when you need to answer questions about calculation.",
        "parameters": [
            {
                "name": "query",
                "type": "string",
