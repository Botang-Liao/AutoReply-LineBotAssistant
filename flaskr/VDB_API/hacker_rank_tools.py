...
from VDB_API.utils.config import (CHAT_MODELS, DEVICE,
                                  PROMPT_TEMPLATE)
    ...
    def set_llm_type(self, llm_type: str):      
        if llm_type in CHAT_MODELS.keys():
            if llm_type == "offline":
                ...
                model = AutoModelForCausalLM.from_pretrained(CHAT_MODELS["offline"], trust_remote_code=True, device_map = 'auto').eval()
